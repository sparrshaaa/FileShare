...
const appCss = "/assets/styles-D7g37527.css";
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-5 w-5" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-semibold tracking-tight", children: "SecureShare" })
    ] }),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/60 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-6 py-8 text-sm text-muted-foreground sm:flex-row", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Built with React, Tailwind & Flask." })
  ] }) });
}
...
const $$splitComponentImporter$2 = () => import("./download-P_QFiksK.js");
const Route$2 = createFileRoute("/download")({
  head: () => ({
    meta: [{
      title: "Enter PIN — SecureShare"
    }, {
      name: "description",
      content: "Enter a 5-digit PIN to download a shared file."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./dashboard-COY6J0cZ.js");
const Route$1 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Upload files and manage your shared PINs."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-C8mjp1le.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const DownloadRoute = Route$2.update({
  id: "/download",
  path: "/download",
